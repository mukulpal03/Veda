...
export default function ResultsPage() {
  return (
    <div className="flex flex-col lg:flex-row min-h-screen lg:h-screen bg-gradient-to-br from-[#EAEAEA] to-[#D5D5D5] p-3 lg:p-[12px] gap-3 lg:gap-[12px] overflow-hidden font-sans font-geist-sans">
      <Sidebar />
