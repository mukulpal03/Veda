...
export default function Header() {
  return (
    <header className="flex items-center justify-between px-4 lg:pl-[24px] lg:pr-[8px] gap-2 lg:gap-[10px] bg-[#FFFFFFBF] rounded-[16px] shadow-sm w-full lg:w-[1100px] h-[56px] shrink-0 relative z-10">
      <div className="flex items-center gap-2 lg:gap-4 text-gray-500">
        ...
        <div className="flex lg:hidden items-center gap-2">
          <span className="font-bold text-lg tracking-tight text-[#2C2C2C]">VedaAI</span>
        </div>
        {/* Desktop Breadcrumb */}
      ...
      <div className="flex items-center gap-3 lg:gap-5">
        <div className="flex items-center gap-3 lg:gap-4 text-gray-600">
          <button className="hidden lg:block hover:text-gray-900 transition-colors">
        ...
        <button className="flex items-center gap-3 hover:bg-white/50 px-1 lg:px-2 py-1.5 rounded-full transition-colors">
          ...
          <span className="hidden lg:block text-sm font-semibold text-gray-800 whitespace-nowrap">Madhur Rastogi</span>
          <ChevronDown size={16} className="hidden lg:block text-gray-500" strokeWidth={2} />
        </button>
        
        {/* Mobile Hamburger Menu */}
        <button className="block lg:hidden hover:bg-gray-100 p-1.5 rounded-full transition-colors text-gray-600">
